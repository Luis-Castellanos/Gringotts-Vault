...
export function IconAudit({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
...
export function IconReports({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
...
export function IconRentals({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
...
export function IconInvestments({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
      <path d="M3 3v18h18" />
...
export function IconTax({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
      <path d="M5 19L19 5" />
...
export function IconForecasting({ className, size = 18, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
      <circle cx="12" cy="12" r="9" />
...
export function IconSearch({ className, size = 16, strokeWidth }: IconProps) {
  return (
    <svg {...base(size, className, strokeWidth)}>
