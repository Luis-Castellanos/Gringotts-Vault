...
export const propertySchema = z.object({
  ...
  useType: z.enum(['investment', 'residence']).optional(),
  propertyTaxAnnual: z.number().nonnegative().optional().nullable(),
  insuranceAnnual: z.number().nonnegative().optional().nullable(),
