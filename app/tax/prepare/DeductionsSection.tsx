  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <Panel
        ...
        subtitle={result.deductionKind === 'itemized' ? `Itemizing — total ${fmtMoney0(result.itemizedTotal)}` : `Standard deduction wins (${fmtMoney0(result.deduction)})`}
      >
      ...
      <Panel title="Adjustments to income" subtitle="Above-the-line — reduce AGI">
      ...
      <Panel title="Credits" subtitle="Non-refundable, applied against the tax">
      ...
      <Panel title="Payments & prior year" subtitle="Withholding flows from your documents">
