...
export const POST = handler(async (req: NextRequest) => {
  ...
  const [inserted] = await db
    ...
    .values({
      ...
      useType: b.useType ?? 'investment',
      propertyTaxAnnual: b.propertyTaxAnnual != null ? b.propertyTaxAnnual.toFixed(2) : null,
      insuranceAnnual: b.insuranceAnnual != null ? b.insuranceAnnual.toFixed(2) : null,
      beds: b.beds ?? null,
