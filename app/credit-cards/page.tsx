...
export default async function CreditCardsPage() {
  ...
  // Four independent aggregates: card metadata + balance, cashback YTD, the most
  // recent annual fee, and lifetime spend. Run them in parallel.
  const [rows, cashbackRows, feeRows, spendRows] = await Promise.all([
    db
      .select({
        id: accounts.id,
        name: accounts.name,
